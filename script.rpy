...
label morning:
    ...
    m tired "Чувствую, что ещё один и больше уже никогда не просто бухлостримов, но и обычных стримов не будет."
    ...
    m lstress "А как же видосы, стримы? Да и других дел выше крыши."
    show sausage sad
    s "Оставь ты эти дела на потом. Разве ты не устал от всего этого?"
    ...
    m awsmile "А что, хорошая идея, Никита."
    s "Капитан Никита!"
    m awsmile "Мы ещё не на островах, пират."
    s "Хорошо, тогда я пойду куплю билеты и посмотрю нам отель!"
    m "Ок."
    hide sausage with moveinleft
    ...
    m "Да, намного, спасибо за то, что спросил."
    show sausage smile
    s "Всегда пожалуйста."
    m "Чё делаем?"
    show sausage normal
...
label airport:
    ...
    hide dog with moveoutright
    show staff at rigt
    staff "Добрый день, собака что-то унюхала в вашем чемодане."
    ...
    staff "Прекратите, пожалуйста."
    s "Но я же ещё не дорассказал ахахахахах."
    staff "Мне всё равно."
    staff "Прошу вас пройти со мной к стойке охраны, там мы вас досмотрим."
    "Артём с Никитой подошли к стойке охраны и отдали свои сумки на проверку."
    show staff think at right
    staff "Странно, все чисто. А у вас случаем нет собаки?"
    m "Есть. В смысле... была."
    show staff normal at right
    staff "Тогда понятно, Рекс у нас новенький, он иногда реагирует на чужих собак."
    staff "Простите за беспокойство, можете вернуться к стойке регистрации, я проведу вас без очереди."
    ...
    hide sausage with moveoutright
    "Охраник провёл их к стойке регистрации."
    show staff1
    staff1 "паспорта, пожалуйста"
    staff1 "чемоданы ставьте на ленту"
    staff1 "вы бронировали места заранее?"
    menu:
        "Да":
        ...
        "Нет":
            m "Нет, не успели"
            staff1 "Хорошо, к сожалению, соседних мест не осталось, есть одно у окна и одно в проходе."
            hide staff1 with moveinleft
            show sausage sad 
    ...
    s "Да не, всё заебумба, это точно не сюжетный ход, чтобы не убивать кучу людей при авиакатастрофе.{nw}" #фраза сама себя скипнет.
    ...
    if registration:
        ...
        m "И вправду."
    pilot "Уважаемые пассажиры, усаживайтесь по удобней, мы начинаем взлёт."
    pilot "Просьба не покидать ваши места, пока мы не поднимимся в воздух."
    ...
    pilot "Уважаемые пассажиры, внимание! Мы находимся в зоне турбулентности, поэтому судно будет трясти."
    pilot "Просьба ппристегнутся и оставаться на своих местах, а также сохранять спокойствие."
    ...
    pilot "Уважаемые пассажиры, один из двигателей вышел из строя и нам придётся совершить аварийную посадку."
    m "Блять, ахуенный отпуск."
    s "Надевай кислородную маску быстрее."
    pilot "Пожалуйста, наденьте маски и оставайтесь на своих..."
    #*упали*
    scene bg black
    show text "20 декабря 2019 года 15:37. Падение самолёта в Атлантическом океане. Ведутся поиски, но безуспешно. До пандемии коронавируса 83 дня." with dissolve
